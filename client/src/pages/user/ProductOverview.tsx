...
export default function ProductOverviews() {
  ...
  const renderProducts: Product = allProducts.find(
  ...
  const product = {
    ...
    breadcrumbs: [
      { id: 1, name: "All", href: "#" },
      { id: 2, name: renderProducts?.category, href: "#" },
    ],
    images: [
      {
        src: renderProducts?.image,
    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:grid-cols-2 lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            <div>
